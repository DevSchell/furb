...
public class PlanoTreino {
     ...
     * @param ativo     O status de atividade do plano (true para ativo, false para inativo).
     ...
     * @param descricao A descrição do plano de treino.
     * @param ativo     O status de atividade do plano (true para ativo, false para inativo).
     * @param nivel     O nível do plano, onde 1=Iniciante, 2=Intermediário e 3=Avançado.
     * @throws IllegalArgumentException se a descrição for nula ou vazia.
     */
     ...
     *
     * @param nivel O valor numérico do nível (1 para Iniciante, 2 para Intermediário, 3 para Avançado).
     * @throws IllegalArgumentException se o nível fornecido não estiver entre 1 e 3.
     */
