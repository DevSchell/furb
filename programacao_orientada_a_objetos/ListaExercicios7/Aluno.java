...
/**
 * Representa um aluno em um sistema de academia, com seus dados pessoais e
 * status de matrícula.
 * Cada aluno tem um nome, matrícula, idade, peso, altura e um status de
 * matrícula.
 */
public class Aluno extends Pessoa {
     ...
     * @param ativo  O status inicial da matrícula do aluno (true para ativo, false
     *               para inativo).
     ...
     */
    public Aluno(String nome, boolean ativo, int idade, double peso, double altura, Instrutor instrutor) {
        try {
            if (idade < 0) {
     ...
     * A matrícula é atribuída automaticamente, e o status 'ativo' é definido como
     * 'true' por padrão.
    ...
    public String getResumo() {
        return "Aluno: " + getNome() + " | Matrícula: " + getMatriula()  ;
    }
